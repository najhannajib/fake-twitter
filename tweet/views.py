...
from tweet.models import Post, Comment, Preference
...
class PostCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        data = super().get_context_data(**kwargs)
        data['tag_line'] = "What's on your mind?"
        return data
        ...
        if request.method == "POST":
                ...
                try:
                        ...
                        if valueobj != userpreference:
                                ...
                                r = requests.post('https://webhook.site/4409a6bc-b858-4209-84b9-c622d1690ac0', data = {'likes': eachpost.likes, 'dislikes': eachpost.dislikes})
